...
- [ ] Run the **golden contract test suite**
      (the contracts freeze; its sheet went with the programme's reduction to two files on
      2026-09-01, and the [programme README](../../../consumer/docs/todo/core-server-multitenancy-program/README.md)
      is what is left)
